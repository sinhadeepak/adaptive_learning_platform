...
def _clean_state() -> None:
    ...
    subprocess.run(
        [
            ...
            "marketplace",
            "-c",
            "TRUNCATE marketplace_schema.course_lessons, marketplace_schema.course_modules, marketplace_schema.course_ratings, marketplace_schema.tutor_session_ratings, marketplace_schema.course_purchases, marketplace_schema.courses, marketplace_schema.creator_profiles, marketplace_schema.tutor_admin_actions, "
