...
from learning.content import catalog_client, db
from learning.content.catalog_client import AuthorizeResult
...
def _clean_state(monkeypatch: pytest.MonkeyPatch) -> Iterator[None]:
    ...
    monkeypatch.setattr("learning.content.routes.authorize_topic", _stub_authorize)
    yield
    db._engine = None
    db._sessionmaker = None
