...
from learning.adaptive import mock as mock_mod
...
async def client(monkeypatch: pytest.MonkeyPatch) -> AsyncIterator[AsyncClient]:
    ...
    monkeypatch.setattr("learning.adaptive.mock.fetch_topic_catalog", _stub_catalog)
    monkeypatch.setattr("learning.adaptive.mock.fetch_mastery", _stub_mastery)
    monkeypatch.setattr("learning.adaptive.mock.fetch_similar_problems", _stub_similar)
