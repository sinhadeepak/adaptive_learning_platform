...
from adaptive_engine import rank
...
async def client(monkeypatch: pytest.MonkeyPatch) -> AsyncIterator[AsyncClient]:
    ...
    monkeypatch.setattr("adaptive_engine.rank.fetch_readiness", _readiness)
    monkeypatch.setattr("adaptive_engine.rank.fetch_mastery", _mastery)
...
async def test_rank_projection_cold_start_user(client: AsyncClient, monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    monkeypatch.setattr("adaptive_engine.rank.fetch_readiness", _empty_readiness)
    monkeypatch.setattr("adaptive_engine.rank.fetch_mastery", _empty_mastery)
