...
async def client(monkeypatch: pytest.MonkeyPatch) -> AsyncIterator[AsyncClient]:
    ...
    monkeypatch.setattr("adaptive_engine.study_plan.fetch_mastery", _mastery)
    monkeypatch.setattr("adaptive_engine.study_plan.fetch_readiness", _readiness)
    monkeypatch.setattr("adaptive_engine.study_plan.fetch_topic_catalog", _topics)
    ...
    monkeypatch.setattr("adaptive_engine.study_plan.llm.call_structured", _no_llm)
...
async def test_study_plan_cold_start_user(
    ...
    monkeypatch.setattr("adaptive_engine.study_plan.fetch_mastery", _empty_mastery)
