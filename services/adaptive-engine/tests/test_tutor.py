...
from adaptive_engine import tutor
...
async def client(monkeypatch: pytest.MonkeyPatch) -> AsyncIterator[AsyncClient]:
    ...
    monkeypatch.setattr("adaptive_engine.tutor._fetch_topic", _topic)
    monkeypatch.setattr("adaptive_engine.tutor._resolve_mastery", _mastery)
