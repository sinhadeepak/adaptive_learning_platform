...
**Pending today**: ~12 (S8 Payment + Institution next; S9–S12 = Phase 2; S13–S18 = Phase 3; S19 = staging cutover).
...
| Sprint 12 — Realtime + Invite Revocation + Mobile Onboarding | [32_Sprint12_Realtime_Plan](32_Sprint12_Realtime_Plan.md) → [33_Sprint12_Closure](33_Sprint12_Closure.md) | ✅ DELIVERED 2026-04-28 — Tenant invite list/revoke with token redaction (S12-A, 4 tests), SSE-driven cohort leaderboard with digest-diff polling + EventSource client (S12-B, 6 digest tests), mobile JoinCohort screen + deep-link parser /join/<token> (S12-C, 6 tests), Quiz Go `ASSIGNMENT` mode foundation (S12-D, 1 test). 17 new tests. Stack totals: Institution 36/36, Mobile 120/120. Cross-service Quiz↔Content bridge (the bulk of S12-D-as-originally-scoped) explicitly carried to Sprint 13. |
