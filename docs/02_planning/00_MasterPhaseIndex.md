...
**Pending today**: ~3 (Phase 2 + P3-S0..S3 closed at Sprints S13–S18. Sprint 18 shipped both marketplace channels end-to-end (synchronous tutor sessions + asynchronous creator courses) with ratings + audit; P3-S4 opens course modules + creator earnings + real Stripe/Daily wiring. Staging cutover still AWS-blocked).
