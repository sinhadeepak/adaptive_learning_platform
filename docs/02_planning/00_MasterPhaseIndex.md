...
**Pending today**: ~2 (Phase 2 + P3-S0..S4 closed at Sprints S13–S19. Sprint 19 shipped course modules/lessons + creator earnings + rating moderation + refund flow stub. P3-S5 opens predictive analytics + recommendations per ADR-0010/0011. Staging cutover still AWS-blocked).
